...
public class CycloneX10 : MonoBehaviour
{
    ...
    [DllImport("hid.dll", SetLastError = true)]
    static extern void HidD_GetAttributes(IntPtr hidDeviceObject, out HIDD_ATTRIBUTES attributes);
    ...
    static extern int WriteFile(IntPtr file, byte[] buffer, uint numberBytesToWrite, out uint numberOfBytesWritten, IntPtr overlapped);
    ...
    void Start()
    {
        ...
        try
        {
            ...
            for (int i = 0; ; i++)
            {
                ...
                IntPtr fileHandle = CreateFile(didd.DevicePath, 0, 3, IntPtr.Zero, 3, 0, IntPtr.Zero);
